            ...
            <div className="grid grid-cols-1 gap-8 min-h-full py-10 px-4 md:rounded-sm md:px-8 md:py-20 md:shadow-md md:border-[1px]">
                <div className='flex flex-col gap-4 min-w-[200px] max-w-[300px] md:gap-6'>
                    ...
                    <div className='w-full'>
                        <p className='font-semibold text-center text-blue-950'>Regístrate para continuar</p>
                    </div>
                    <div className='w-full'>
                    ...
                    <div className='w-full'>
                        <button className='bg-blue-950 px-3 py-2 text-white w-full text-sm rounded-sm' onClick={controller.navigateToOtpCode}>Registrarse</button>
                    </div>

                    <div className='w-full text-center'>
                        <Link to="/auth/login" className='text-blue-600 text-sm'>¿Ya tienes una cuenta de Free Space? Iniciar Sesión</Link>
                    </div>
